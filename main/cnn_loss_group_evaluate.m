...
%     work_info_batch.ref.obj_value=obj_value;
    ...
    ray_do_full_eva(work_info_batch, predict_info, group_idx);
...
function ray_do_full_eva(work_info_batch, predict_info, group_idx)
    ...
    prediction = work_info_batch.ref.data_info_groups{group_idx}.ref.output_info_layers{end-1}.x;
    
    ds_info=work_info_batch.ref.imdb.ref.ds_info;
    eva_result_info=my_gen_seg_result(seg_param, ds_info, predict_info, prediction);
